...
void GenJetsNtuplizer::fillBranches( edm::Event const & event, const edm::EventSetup& iSetup ){
  ...
  for (const pat::Jet &j : *genJetsAK8_) {
    ...
    nBranches_->genJetAK8_tau1        .push_back(j.userFloat("NjettinessGenAK8:tau1"));
    nBranches_->genJetAK8_tau2        .push_back(j.userFloat("NjettinessGenAK8:tau2"));
    nBranches_->genJetAK8_tau3        .push_back(j.userFloat("NjettinessGenAK8:tau3"));
